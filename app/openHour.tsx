  ...
  return (
    <section className='py-20 gap-y-16 flex  justify-center flex-col items-center bg-main w-full'>
      ...
      <div className=' w-full flex gap-8  justify-around items-center '>
        ...
        <div className='flex md:w-92 w-full relative  rounded-2xl justify-center bg-indigo-100 items-center flex-col'>
            <div className='w-16 h-16 bg-primary absolute -top-8 right-5 rounded-xl grid place-items-center  text-white'><IoMdTime className='text-5xl text-white font-bold' /></div>
